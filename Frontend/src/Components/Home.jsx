  ...
  return (
    <div className='h-auto md:h-[90vh] w-[100vw] md:w-full  bg-gradient-to-b from-gray-800 to-gray-700  text-white  py-10 flex flex-col gap-10 overflow-y-hidden'>
      ...
      <div className="text-center -mt-3">
        ...
        <p className=" mb-6">Your all-in-one tool for budgeting, saving, and financial clarity.</p>
        <button className="bg-cyan-600 text-white px-6 py-2 rounded-lg hover:bg-cyan-700 transition">Get Started Now</button>
      </div>
