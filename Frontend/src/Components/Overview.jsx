...
const Overview = () => {
  ...
  return (
    <div className='min-h-screen w-full bg-gradient-to-b from-gray-800 to-gray-700 text-white px-4 py-8 md:px-6 md:py-10 flex flex-col gap-8 md:gap-10'>
      ...
      <div className='w-full max-w-4xl mx-auto'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          ...
          <div className={`backdrop-blur-sm bg-white/10 p-6 rounded-xl shadow-xl hover:scale-105 transition-transform duration-300 ${
            income - expenses >= 0 ? 'text-cyan-400' : 'text-red-400'
          }`}>
